...
public class SeleneseCommands {

	private String[] seleneseCmds = {
			"addCollection",
			"addLocationStrategy",
			"addSelection",
			"addToCollection",
	...
	public SeleneseCommands() {
	}
	
	public List<KeywordEntry> getKeywords() {
		List<KeywordEntry> allKeywords= new ArrayList<>();
		
		for (String aKeyword : seleneseCmds) {
			allKeywords.add(new KeywordEntry(SeleneseTestAdaptionPlugin.ID, aKeyword, "", ""));
		}
